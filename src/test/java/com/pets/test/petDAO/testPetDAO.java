...
public class testPetDAO {
	...
	@Commit
	void enumerateTable() {
		PetType petType = enumRepo.createPetType("real");
		PetStatus petStatus = enumRepo.createPetStatus("unadopted");

		assertTrue(petType.getPet_type_id() != 0);
		assertTrue(petStatus.getPet_status_id() != 0);
	}
